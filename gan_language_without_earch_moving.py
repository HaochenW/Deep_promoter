...
#fake_inputs = tf.one_hot(fake_inputs, len(charmap))
...
# JS divergency to replace earth moving distance 
#d_loss_real = tf.reduce_mean(
#      sigmoid_cross_entropy_with_logits(disc_real, tf.ones_like(disc_real)))
#d_loss_fake = tf.reduce_mean(
#      sigmoid_cross_entropy_with_logits(disc_fake, tf.zeros_like(disc_fake)))
#g_loss = tf.reduce_mean(
#      sigmoid_cross_entropy_with_logits(disc_fake, tf.ones_like(disc_fake)))

#d_loss_real = tf.reduce_mean(tf.math.log(disc_real))
#d_loss_fake = tf.reduce_mean(tf.math.log(tf.ones_like(disc_fake) - disc_fake))
#g_loss = tf.reduce_mean(tf.math.log(tf.ones_like(disc_fake) - disc_fake))
#
...
part1 = tf.reduce_mean(tf.nn.sigmoid_cross_entropy_with_logits(labels = tf.ones_like(disc_real), logits = disc_real))
part2 = tf.reduce_mean(tf.nn.sigmoid_cross_entropy_with_logits(labels = tf.zeros_like(disc_fake), logits = (disc_fake)))
disc_cost = part1 + part2
gen_cost = tf.reduce_mean(tf.nn.sigmoid_cross_entropy_with_logits(labels = tf.ones_like(disc_fake), logits = disc_fake))
